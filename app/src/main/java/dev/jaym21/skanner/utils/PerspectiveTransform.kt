...
internal object PerspectiveTransformation {
    ...
    private fun getRectangleSize(rectangle: MatOfPoint2f): Size {
        ...
        val top = MathUtils.getDistance(corners[0], corners[1])
        val right = MathUtils.getDistance(corners[1], corners[2])
        val bottom = MathUtils.getDistance(corners[2], corners[3])
        val left = MathUtils.getDistance(corners[3], corners[0])
